...
public class Cricket_Player extends Athletic_Player{
	...
	public Cricket_Player(int aid, String aname, String paddress, String dob, String teamname, int jersyno, int totalruns,
