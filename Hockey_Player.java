...
public class Hockey_Player extends Athletic_Player {
	private String teamname;
	private int jersyno;
	private int totalgoals;
	private int max_goal_in_a_match;
	private int total_matched_played;
	public Hockey_Player(int aid, String aname, String paddress, String dob, String teamname, int jersyno, int totalgoals,
